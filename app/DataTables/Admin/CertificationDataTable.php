...
class CertificationDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'admin.certifications.datatables_actions')
        ->editColumn('picture', function ($certification) 
        {  return '<img src='.$certification->picture.' height="80px"/>'; })
    ...
    {
        return 'certificationsdatatable_' . time();
    }
}
