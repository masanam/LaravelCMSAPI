...
class DirectorDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'admin.directors.datatables_actions')
        ->editColumn('picture', function ($director) 
        {  return '<img src='.$director->picture.' height="80px"/>'; })
     ...
     */
    public function query(Director $model)
    {
    ...
    {
        return 'directorsdatatable_' . time();
    }
}