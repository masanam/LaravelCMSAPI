...
class TestimonyDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'admin.testimonies.datatables_actions')
     ...
     */
    public function query(Testimony $model)
    {
    ...
    {
        return 'testimoniesdatatable_' . time();
    }
}
