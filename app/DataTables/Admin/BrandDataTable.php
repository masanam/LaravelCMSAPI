...
class BrandDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'admin.brands.datatables_actions')
        ->editColumn('picture', function ($brand) 
        {  return '<img src='.$brand->picture.' height="80px"/>'; })
    ...
    protected function getColumns()
    {
        return [
            'id' => [ 'visible' => false ],
            'type' => ['name' => 'type.title', 'data' => 'type.title', 'defaultContent'=> '', 'searchable'=>false],
            'title',
            'picture',
            'orderid',
