...
@section('contents')
        ...
        <div class="container">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                <div>
                    ...
                    <!-- <h1 class="mg-b-0 tx-spacing--1">Roles</h1> -->
                </div>
                ...
                <div class="d-none d-md-block">
                    ...
                    <a class="btn btn-sm btn-primary btn-uppercase" href="{!! route('admin.roles.create') !!}"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>

            <h4 class="mg-b-10">Roles</h4>
    ...
    {{--<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <form class="modal-content" action="{!! url('importRole') !!}" method="post" enctype="multipart/form-data">
