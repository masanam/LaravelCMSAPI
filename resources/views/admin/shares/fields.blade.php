...
<div class="form-group col-sm-6">
    ...
    {!! Form::date('tanggal', old('tanggal', isset($share) ? $share->tanggal : '') , ['class' => 'form-control date']) !!}

</div>

<!-- Price Field -->
<div class="form-group col-sm-6">
    {!! Form::label('price', 'Harga Penutupan:', ['class' => 'd-block']) !!}
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('admin.shares.index') !!}" class="btn btn-light">Cancel</a>
</div>
