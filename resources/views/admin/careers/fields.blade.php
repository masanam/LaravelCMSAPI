  ...
  <div class="tab-pane fade show active" id="idtab" role="tabpanel" aria-labelledby="id-tab">
    <!-- tab1 -->
        ...
        <div class="form-group col-sm-12 col-lg-12">
            ...
            <textarea name="content" class="form-control my-editor">{!! old('content', isset($career) ? $career->content : '') !!}</textarea>
        </div>
        </div>
    ...
    <!-- tab1 -->
        ...
        <div class="form-group col-sm-12 col-lg-12">
            ...
            <textarea name="content_en" class="form-control my-editor">{!! old('content_en', isset($career) ? $career->content_en : '') !!}</textarea>
        </div>
        </div>
</div>    
<br/>     
<!-- Status Field -->
<div class="form-group col-sm-6">
    {!! Form::label('category_id', 'Group:') !!}
    {!! Form::select('category_id', $group->pluck('title', 'id'), null, ['class' => 'form-control select2']) !!}
</div>
 ...
 {!! Form::label('picture', 'Picture:') !!}
    ...
    <img id="holder" src="{{ isset($career) ? $career->picture : '' }}" style="padding:10px;max-width:600px;max-height:300px">
    </div>
	<div class="input-group">
    <input class="form-control" type="text" id="picture" name="picture" value="{{ old('picture', isset($career) ? $career->picture : '') }}">
 ...
 @if (isset($career))
    <div class="form-group col-sm-6">
        ...
        <input type="checkbox" class="custom-control-input" value="1" name="home" id="customCheck1" {{ $career->home == '1' ? 'checked' : '' }}>
...
@else
    <div class="form-group col-sm-6">
        <div class="custom-control custom-checkbox">
        <input type="checkbox" class="custom-control-input" value="1" name="home" id="customCheck1">
        <label class="custom-control-label" for="customCheck1">Home</label>
        </div>
</div>
@endif
