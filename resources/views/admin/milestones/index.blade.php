...
@section('contents')
        ...
        <div class="container">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                <div>
                    ...
                    <!-- <h1 class="mg-b-0 tx-spacing--1">Milestones</h1> -->
                </div>
                ...
                <div class="d-none d-md-block">
                    ...
                    <a class="btn btn-sm btn-primary btn-uppercase" href="{!! route('admin.milestones.create') !!}"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>

            <h4 class="mg-b-10">Milestones</h4>

            <div data-label="List" class="df-example demo-forms">

            <div class="table table-striped table-responsive">
                @include('admin.milestones.table')
            </div>
            </div>
    ...
    {{--<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <form class="modal-content" action="{!! url('importMilestone') !!}" method="post" enctype="multipart/form-data">
