...
<div class="form-group col-sm-12 col-lg-12">
    ...
    <textarea name="description" class="form-control my-editor">{!! old('description', isset($advisor) ? $advisor->description : '') !!}</textarea>
</div>
</div>
    ...
    <!-- tab1 -->
        ...
        <div class="form-group col-sm-12 col-lg-12">
            ...
            <textarea name="description_en" class="form-control my-editor">{!! old('description_en', isset($advisor) ? $advisor->description_en : '') !!}</textarea>
        </div>
        </div>
</div>    
<br/>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('admin.advisors.index') !!}" class="btn btn-light">Cancel</a>
</div>
