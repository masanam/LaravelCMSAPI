  ...
  <div class="tab-pane fade show active" id="idtab" role="tabpanel" aria-labelledby="id-tab">
    <!-- tab1 -->
            ...
            <div class="form-group col-sm-12 col-lg-12">
                ...
                <textarea name="content" class="form-control my-editor">{!! old('content', isset($release) ? $release->content : '') !!}</textarea>
            </div>
            </div>
    ...
    <!-- tab1 -->
        ...
        <div class="form-group col-sm-12 col-lg-12">
            ...
            <textarea name="content_en" class="form-control my-editor">{!! old('content_en', isset($release) ? $release->content_en : '') !!}</textarea>
        </div>
        </div>
</div>    
<br/>  
...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('category_id', $varian->pluck('title', 'id'), null, ['class' => 'form-control select2']) !!}
</div>
 ...
 {!! Form::label('picture', 'Picture:') !!}
    ...
    <img id="holder" src="{{ isset($release) ? $release->picture : '' }}" style="padding:10px;max-width:600px;max-height:300px">
    </div>
	<div class="input-group">
    <input class="form-control" type="text" id="picture" name="picture" value="{{ old('picture', isset($release) ? $release->picture : '') }}">
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('admin.releases.index') !!}" class="btn btn-light">Cancel</a>
</div>
