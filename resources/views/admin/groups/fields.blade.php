  ...
  <div class="tab-pane fade show active" id="idtab" role="tabpanel" aria-labelledby="id-tab">
    <!-- tab1 -->
        ...
        <div class="form-group col-sm-12 col-lg-12">
            ...
            <textarea name="content" class="form-control my-editor">{!! old('content', isset($group) ? $group->content : '') !!}</textarea>
        </div>
    </div>
    ...
    <!-- tab1 -->
        ...
        <div class="form-group col-sm-12 col-lg-12">
            ...
            <textarea name="content_en" class="form-control my-editor">{!! old('content_en', isset($group) ? $group->content_en : '') !!}</textarea>
        </div>
        </div>
</div>    
<br/>
 ...
 {!! Form::label('picture', 'Picture:') !!}
    ...
    <img id="holder" src="{{ isset($group) ? $group->picture : '' }}" style="padding:10px;max-width:600px;max-height:300px">
    </div>
	<div class="input-group">
    <input class="form-control" type="text" id="picture" name="picture" value="{{ old('picture', isset($group) ? $group->picture : '') }}">
