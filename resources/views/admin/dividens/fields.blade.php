...
<!-- Total Field -->
<div class="form-group col-sm-6">
    {!! Form::label('total', 'Total:', ['class' => 'd-block']) !!}
    {!! Form::text('total', null, ['class' => 'form-control']) !!}
</div>

<!-- Share Field -->
<div class="form-group col-sm-6">
    {!! Form::label('share', 'Share:', ['class' => 'd-block']) !!}
...
<div class="form-group col-sm-6">
    ...
    {!! Form::date('payment_date', old('payment_date', isset($dividen) ? $dividen->payment_date : '') , ['class' => 'form-control date']) !!}
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('admin.dividens.index') !!}" class="btn btn-light">Cancel</a>
</div>
