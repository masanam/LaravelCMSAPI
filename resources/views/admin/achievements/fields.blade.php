  ...
  <div class="tab-pane fade show active" id="idtab" role="tabpanel" aria-labelledby="id-tab">
    <!-- tab1 -->
        ...
        <div class="form-group col-sm-12 col-lg-12">
            ...
            <textarea name="content" class="form-control my-editor">{!! old('content', isset($achievement) ? $achievement->content : '') !!}</textarea>
        </div>
        </div>
    ...
    <!-- tab1 -->
        ...
        <!-- Content Field -->
        <div class="form-group col-sm-12 col-lg-12">
            {!! Form::label('content_en', 'Description [EN]:', ['class' => 'd-block']) !!}
            <textarea name="content_en" class="form-control my-editor">{!! old('content_en', isset($achievement) ? $achievement->content_en : '') !!}</textarea>
        </div>
        </div>
</div>    
<br/>   
...
<div class="form-group col-sm-6">
 ...
 {!! Form::label('picture', 'Picture:') !!}
    ...
    <img id="holder" src="{{ isset($achievement) ? $achievement->picture : '' }}" style="padding:10px;max-width:600px;max-height:300px">
    </div>
	<div class="input-group">
    <input class="form-control" type="text" id="picture" name="picture" value="{{ old('picture', isset($achievement) ? $achievement->picture : '') }}">
 ...
 <select class="form-control select2" name="type">
    @if (isset($achievement))
            <option value="1" {{ ( $achievement->type == '1') ? 'selected' : '' }}> Corporate </option>
            <option value="2" {{ ( $achievement->type == '2') ? 'selected' : '' }}> Brand </option>
            @else
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('admin.achievements.index') !!}" class="btn btn-light">Cancel</a>
</div>
