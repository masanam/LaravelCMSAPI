...
<div class="form-group col-sm-12 col-lg-12">
    ...
    <textarea name="description" class="form-control my-editor">{!! old('description', isset($varian) ? $varian->description : '') !!}</textarea>
...
<div class="form-group col-sm-12 col-lg-12">
 {!! Form::label('picture', 'Picture:') !!}
    ...
    <img id="holder" src="{{ isset($varian) ? $varian->picture : '' }}" style="padding:10px;max-width:600px;max-height:300px">
    </div>
	<div class="input-group">
    <input class="form-control" type="text" id="picture" name="picture" value="{{ old('picture', isset($varian) ? $varian->picture : '') }}">
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('admin.varians.index') !!}" class="btn btn-light">Cancel</a>
</div>
