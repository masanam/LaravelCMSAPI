...
<html lang="en">
  <head>
    ...
    <!-- Facebook -->
    <meta property="og:url" content="http://www.kino.co.id/dashforge">
  ...
  <body>
          ...
          <!-- <div class="sign-wrapper mg-lg-r-50 mg-xl-r-60"> -->
            <div class="pd-t-20 wd-100p">
              ...
              <div class="form-group">
                <label>Name</label>
                <input type="text" name="name" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Enter your firstname">
              ...
              <div class="form-group">
                ...
                <input type="email" name="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="Enter your email address">
              ...
              <div class="form-group">
                ...
                <input type="password" name="password_confirmation" class="form-control{{ $errors->has('password_confirmation') ? ' is-invalid' : '' }}" placeholder="Enter to confirm your password">
    ...
    <footer class="footer">
      <div>
        ...
        <span>Created by <a href="http://www.kino.co.id">webcore</a></span>
      </div>
      <div>
        <nav class="nav">
