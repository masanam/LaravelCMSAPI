...
@section('contents')
    ...
    <section class="content-header">
        <h4 class="pull-left">Profiles</h4>
        <div class="pull-right">
            {{--<button type="button" class="btn btn-info pull-right" style="margin-right: 5px" data-toggle="modal" data-target="#myModal">
                Import Excel File
            </button>--}}
            <a class="btn btn-primary pull-right" href="{!! route('profiles.create') !!}">Add New</a>
        </div>
    </section>
    <div class="content">
